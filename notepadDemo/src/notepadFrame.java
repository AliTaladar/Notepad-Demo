...
public class notepadFrame extends JFrame {
    ...
    private PrinterJob printerJob;  // Printer job for print operations
    private PageFormat pageFormat;  // Page format for printing
    ...
    public notepadFrame(String text) {
        ...
        // Initialize printer job and page format
    ...
    private JMenu makeFileMenu() {
        ...
        itemPageSetup.addActionListener(e -> showPageSetup());
        itemPrintPreview.addActionListener(e -> showPrintPreview());
        itemPrint.addActionListener(e -> printDocument());
